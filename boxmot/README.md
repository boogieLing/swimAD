...
```
git clone https://github.com/mikel-brostrom/boxmot.boxmot.git
cd boxmot
pip install uv
uv sync --group yolo
...
|---------------------|----------|
| Torchvision bounding box tracking with BoxMOT | [![Notebook](https://img.shields.io/badge/Notebook-torchvision_det_boxmot.boxmot.ipynb-blue)](examples/det/torchvision_boxmot.boxmot.ipynb) |
| Torchvision pose tracking with BoxMOT | [![Notebook](https://img.shields.io/badge/Notebook-torchvision_pose_boxmot.boxmot.ipynb-blue)](examples/pose/torchvision_boxmot.boxmot.ipynb) |
| Torchvision segmentation tracking with BoxMOT | [![Notebook](https://img.shields.io/badge/Notebook-torchvision_seg_boxmot.boxmot.ipynb-blue)](examples/seg/torchvision_boxmot.boxmot.ipynb) |
