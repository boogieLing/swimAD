...
from boxmot.tracking.detection_entry import DetectionEntry
from boxmot.tracking.drowning_detector import DrowningDetector
from boxmot.tracking.track_lifecycle import TrackManagerController
from boxmot.tracking.track_window_manager import TrackWindowManager
...
from boxmot.tracking.detectors import (get_yolo_inferer, default_imgsz,
...
from boxmot.boxmot.multi_view_association.test_stream_split import MultiViewAssociationStream, POOL_WIDTH, POOL_HEIGHT, \
...
if __name__ == "__main__":
    ...
    track_controller = TrackManagerController(ttl=10, snapshot_interval=30, frame_window_span=50)
