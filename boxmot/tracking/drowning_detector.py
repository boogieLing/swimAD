...
class DrowningDetector:
    ...
    def rule_1_head_ratio(self) -> RuleResult:
        ...
        self.logger.info(f"[Rule 1] head_underwater_ratio = {ratio:.3f}")
    ...
    def rule_2_velocity_acc(self) -> RuleResult:
        ...
        self.logger.info(f"[Rule 2] velocity = {mean_v:.3f}, acc = {mean_a:.3f}")
    ...
    def rule_3_jitter(self) -> RuleResult:
        ...
        self.logger.info(f"[Rule 3] jitter = {jitter:.3f}")
    ...
    def rule_4_underwater_streak(self) -> RuleResult:
        ...
        self.logger.info(f"[Rule 4] max_underwater_duration = {duration:.2f}s")
    ...
    def rule_5_drop_event(self) -> RuleResult:
        ...
        duration = max_len / self.fps
        self.logger.info(f"[Rule 5] drop_event: f={f:.2f}, b={b:.2f}, max_dur={duration:.2f}s")
    ...
    def rule_6_low_variance(self) -> RuleResult:
        ...
        self.logger.info(f"[Rule 6] variance = {drift:.4f}")
    ...
    def rule_7_repeat_location(self) -> RuleResult:
        ...
        self.logger.info(f"[Rule 7] repeat_location = {repeat}")
    ...
    def rule_8_direction_change(self) -> RuleResult:
        ...
        self.logger.info(f"[Rule 8] avg_dir_change = {avg_angle:.3f}")
    ...
    def rule_9_path_ratio(self) -> RuleResult:
        ...
        self.logger.info(f"[Rule 9] path_ratio = {ratio:.3f}")
