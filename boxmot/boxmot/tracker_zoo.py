...
import yaml
from boxmot.boxmot.utils import BOXMOT, TRACKER_CONFIGS
...
def create_tracker(
    ...
    tracker_mapping = {
        ...
        'bytetrack': 'boxmot.boxmot.trackers.bytetrack.bytetrack.ByteTrack',
        'botsort': 'boxmot.boxmot.trackers.botsort.botsort.BotSort',
        'deepocsort': 'boxmot.boxmot.trackers.deepocsort.deepocsort.DeepOcSort',
        'hybridsort': 'boxmot.boxmot.trackers.hybridsort.hybridsort.HybridSort',
        'imprassoc': 'boxmot.boxmot.trackers.imprassoc.imprassoctrack.ImprAssocTrack',
