...
from boxmot.boxmot.appearance.reid.config import MODEL_TYPES, TRAINED_URLS, NR_CLASSES_DICT
from boxmot.boxmot.appearance.reid.factory import MODEL_FACTORY
...
class ReIDModelRegistry:
    ...
    def build_model(name, num_classes, loss="softmax", pretrained=True, use_gpu=True):
        ...
        if 'clip' in name:
            from boxmot.boxmot.appearance.backbones.clip.config.defaults import _C as cfg
